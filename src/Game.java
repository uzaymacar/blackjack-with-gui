...
public class Game {
  ...
  public boolean roundOver; //this boolean value will tell the program if the round is over.
  ...
  public static void rest() {//this method sleeps the program. It basically serves as a time duration between events.
    try {
      Thread.sleep(1000);//this sleeps the program for 1000 miliseconds which is equal to 1 second.
    }
